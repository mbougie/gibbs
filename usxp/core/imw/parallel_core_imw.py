...
def createReclassifyList(data):
    ...
    query = " SELECT \"Value\", mtr from pre_imw.{} as a JOIN pre_imw.{} as b ON a.traj_array = b.traj_array".format(data['pre']['traj']['filename'], data['pre']['traj']['lookup'])
    # print 'query:', query
...
def execute_task(args):
	...
	if data['core']['route'] == 'r1':
		...
		t1 = Con(IsNull(filled_1),FocalStatistics(filled_1,NbrRectangle(10, 10, "CELL"),'MAJORITY'), filled_1)
