...
raster = "intact_compare_region_refined"
counties = 'E:\\data\\general\\shapefiles.gdb\\counties'
#### combine nlcd datasets
# rstlist = ['D:\\intactland\\intact_clu\\final\\current.gdb\\intactland_15_refined', 'D:\\intactland\\intact_nlcd\\intact_nlcd.gdb\\nlcd_intact_01to16_refined', 'D:\\intactland\\intact_pete\\intact_pete.gdb\\intact_pete_raster_b']
# outCombine = Combine(rstlist)

#### save raster in a different gdb
gdb = 'D:\\intactland\\intact_compare\\intact_compare.gdb'
arcpy.env.workspace = gdb
# outCombine.save(raster)


##########crete zonal histogram ###################################
...
gen.addGDBTable2postgres_histo_counties(gdb=gdb, pgdb='intactland', schema='intact_compare', table='{}_hist_counties'.format(raster))
