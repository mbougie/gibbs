...
####SDSU##########################
# mapa.df$fill <- cut(mapa.df$perc,  breaks= c(75,80,85,90,95,100))
...
### create a discrete scale. These functions allow you to specify your own set of mappings from levels in the data to aesthetic values.
  ...
  theme(
    ...
    #### modified attributes ########################
    text = element_text(color = "#4e4d47", size=60),   ##these are the legend numeric values
    legend.position = c(0.05, 0.01),
    plot.title = element_text(size= 90, vjust=-12.0, hjust=0.10, color = "#4e4d47"),
...
### NLCD ##############
ggsave('D:\\intactland\\graphics\\compare\\compare_nlcd.png', width = 40, height = 40, dpi = 500)
### SDSU ##############
# ggsave('D:\\intactland\\graphics\\compare\\compare_sdsu.png', width = 40, height = 40, dpi = 500)
