...
# try:
#     conn = psycopg2.connect("dbname='cdl_nlcd' user='mbougie' host='144.92.235.105' password='Mend0ta!'")
# except:
...
###### call functions  #################################
# createReclassifyList('cdl_nlcd' , 'SELECT value, b_v2 FROM nlcd.lookup_nlcd30_1992_v1_mod')
# reclassifyRaster(gdb_in, inraster, gdb_out, outraster, reclasslist
