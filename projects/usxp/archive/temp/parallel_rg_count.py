...
def mosiacRasters():
	...
	# ref_raster=Raster('C:\\Users\\Bougie\\Desktop\\Gibbs\\data\\usxp\\pre\\traj\\v4\\v4_traj.gdb\\v4_traj_cdl30_b_2008to2017')

	# filename = 's18_mtr3_counts'
	# print 'filename:', filename
	
	# gdb = 'C:\\Users\\Bougie\\Desktop\\Gibbs\\data\\usxp\\sa\\r2\\s18\\core\\core_s18.gdb'
	# ######mosiac tiles together into a new raster
	# arcpy.MosaicToNewRaster_management(tilelist, gdb, filename, ref_raster.spatialReference, "16_BIT_UNSIGNED", 30, "1", "LAST","FIRST")
	...
	# arcpy.DeleteField_management('{}\\{}'.format(gdb,filename),["Count"])
