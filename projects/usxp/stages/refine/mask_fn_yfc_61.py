...
# def getPixelsPerTile(fc):
# 	pixels_cols=153811
# 	pixels_rows=96523

# 	fishnet_values={"mask_mtr":{"rws":7,"cls":7}, "fishnet_cdl_7_49":{"rws":7,"cls":49}}

# 	tile_rws = pixels_rows/fishnet_values[fc]["rws"]
# 	tile_cols = pixels_cols/fishnet_values[fc]["cls"]

# 	return tile_rws, tile_cols
			...
			if(61 in entirelist):
				...
				if(beforelist.size >= 2):
					...
					if(cond1 and cond2 and cond3 and cond4):
						# print 'has only uniques elements -1 and 0 in numpy diff list so proceeding with processing!!'
						# print 'entirelist---', entirelist
						# print 'beforelist---', beforelist
						# print 'traj_array_before---', traj_array_before
						# print 'afterlist---', afterlist
						# print 'numpy diff', np.diff(traj_array_before)
						...
						# print 'local position+++++++++++++++++++++++++++++++++++++++', int(str(row) + str(col))
						# outData[row,col] = int(str(row) + str(col))

						#### QAQC(fnc)
						# outData[row,col] = entirelist[getIndex(traj_array_before)]
