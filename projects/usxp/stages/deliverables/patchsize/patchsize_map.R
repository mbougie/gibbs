...
setwd('I:\\d_drive\\projects\\usxp\\series\\s35\\deliverables\\patchsize')
r1 = raster('tif\\s35_patchsize_bs15km_mean.tif')
...
# r1_df = r1_df[r1_df$value < 1000,]
r1_df$value[r1_df$value >= 500] <- 500
hist(r1_df$value,breaks = 1000)
...
fileout = 'I:\\d_drive\\projects\\usxp\\series\\s35\\deliverables\\patchsize\\deliverables\\test.png'
