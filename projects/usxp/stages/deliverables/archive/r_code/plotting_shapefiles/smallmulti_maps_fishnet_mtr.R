...
mapa <- readOGR(dsn="D:\\projects\\usxp\\current_deliverable\\5_23_18\\sf", layer="fishnet_yxc")
...
query <- dbGetQuery(con, "SELECT label::int as year, LTRIM(variable,'oid_') as id,value FROM deliverables.s25_ytc_zh_large;")
...
rr + ggtitle("Percent Conversion to Crop")
