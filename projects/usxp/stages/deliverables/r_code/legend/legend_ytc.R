...
df <- dbGetQuery(con, "SELECT a.value as year, acres, color_ytc, round(((acres/(select sum(acres) from counts_yxc.s25_ytc30_2008to2017_mmu5))*100),2) as perc FROM misc.lookup_yxc as a, counts_yxc.s25_ytc30_2008to2017_mmu5 as b WHERE a.value = b.value;")
