...
# r_df$fill = cut(r_df$value, breaks= c(0, 0.5, 2, 4, 8, 100000))
r_df$fill = cut(r_df$value, breaks= c(0, 1, 2, 4, 8, 100000))
# r_df$fill = cut(r_df$value, breaks= c(0.5, 2.5, 5, 7.5, 10, 100000))
#### stats
