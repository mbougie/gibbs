...
source("C:\\Users\\Bougie\\Desktop\\Gibbs\\scripts\\projects\\usxp\\stages\\deliverables\\synthesis\\rcode\\graphics_map_for_panels_extensification.R")
...
# list_exp <- getggplotObject(c('ratio_expand_rfs_mlra'))
# list_aban <- getggplotObject(c('ratio_abandon_rfs_mlra'))
