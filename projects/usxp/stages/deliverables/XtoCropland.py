...
def main(instance):
	...
	for key, reclasslist in instance['reclass'].iteritems():
		for scale in instance['scale'].keys():
			outraster = 'D:\\projects\\usxp\\deliverables\\{0}\\maps\\xtocropland\\xtocropland.gdb\\{0}_{1}_{2}'.format(instance['series'], scale, key)
...
for key, value in scale_dict.iteritems():
	...
	instance = {'series':'s26', 'scale':{key:value}, 'reclass':{'forest':[[63,1],[141,1],[142,1],[143,1]], 'wetland':[[83,1],[87,1],[190,1],[195,1]], 'grassland':[[37,1],[62,1],[171,1],[176,1],[181,1]], 'shrubland':[[64,1],[65,1],[131,1],[152,1]]} }
	print instance
