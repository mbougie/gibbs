...
setwd('I:\\d_drive\\projects\\usxp\\series\\s35\\deliverables\\slope\\tif')
r1 = raster('s35_slope_null_bs3km_mean.tif')
...
labs(title = '') + 
  ...
  scale_fill_gradient(low = "#fcf6a8",
                      high = '#812703'
  ) + 
...
fileout = 'I:\\d_drive\\projects\\usxp\\series\\s35\\deliverables\\slope\\maps\\test.png'
