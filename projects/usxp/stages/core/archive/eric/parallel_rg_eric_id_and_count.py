...
def reclassTiles(data, field, mtr):
	tilelist = glob.glob("C:/Users/Bougie/Desktop/Gibbs/data/tiles/*.tif")
	print 'tilelist:', tilelist 
...
def mosiacRasters(data, mtr, field):
	...
	filename = '{}_mtr{}_{}'.format(data['global']['instance'], mtr, field)
...
def run(data):
	...
	reclassTiles(data, 'id', '3')
	reclassTiles(data, 'count', '3')


	reclassTiles(data, 'id', '4')
	reclassTiles(data, 'count', '4')
