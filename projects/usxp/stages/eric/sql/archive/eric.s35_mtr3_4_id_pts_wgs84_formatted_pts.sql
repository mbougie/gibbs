create table eric.s35_mtr3_4_id_pts_wgs84_formatted_pts_geom as  

SELECT 
  s35_mtr3_4_id_pts_wgs84.gridcode, 
  st_x((ST_Dump(s35_mtr3_4_id_pts_wgs84.wkb_geometry)).geom) as lon,
  st_y((ST_Dump(s35_mtr3_4_id_pts_wgs84.wkb_geometry)).geom) as lat, 
