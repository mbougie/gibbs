...
def execute_task(args):
	...
	refined_raster_mask = replace_61_w_hard_crop.run(data, raster_yxc, raster_yxc_cdl, XMin, YMin, XMax, YMax, croplist_subset)
...
# if __name__ == '__main__':
	...
	for row in arcpy.da.SearchCursor('C:\\Users\\Bougie\\Desktop\\Gibbs\\data\\usxp\\ancillary\\vector\\shapefiles.gdb\\fishnet_yxc_temp', ["oid","SHAPE@"]):
