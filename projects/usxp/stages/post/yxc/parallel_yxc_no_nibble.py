...
def execute_task(args):
	...
	final = SetNull(path_mtr, raster_mask, "VALUE <> {}".format(str(yxc_dict[yxc])))
	raster_mask = None
...
def mosiacRasters(data, yxc):
	...
	filename = data['post'][yxc]['filename']+'_no_nibble'
	...
	arcpy.BuildRasterAttributeTable_management(data['post'][yxc]['path']+'_no_nibble', "Overwrite")

	# Overwrite pyramids
	gen.buildPyramids(data['post'][yxc]['path']+'_no_nibble')
