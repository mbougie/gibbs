...
df <- dbGetQuery(con, "SELECT years,acres,series,yxc,series_order FROM counts_yxc.merged_series where yxc = 'yfc' AND (series='s25' OR series='s26'  OR series='s27' OR series='s28') ")
