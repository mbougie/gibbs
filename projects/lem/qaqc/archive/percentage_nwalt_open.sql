...
WHERE 
  spatial.states_102003.statefp = zonal_hist_nwalt_60m_state.atlas_st;
...
WHERE 
  spatial.states_102003.atlas_st = zonal_hist_nwalt_60m_state.atlas_st and value IN ('31','32','33','50','60')
GROUP BY atlas_name, acres_calc
order by ((sum(zonal_hist_nwalt_60m_state.count) * 0.8895794)/ acres_calc) * 100 DESC