...
create table v3_3.qaqc_accounting_block as 
...
SELECT 
  5 as index,
  'v3_3.block_final_nwalt21_refined' as dataset, 
  'final' as stage,
  count(geoid)
FROM 
  v3_3.block_final_nwalt21_refined
...
SELECT 
  5 as index,
  'v3_3.block_final_nwalt21_unrefined' as dataset, 
  'final' as stage,
  count(geoid)
FROM 
  v3_3.block_final_nwalt21_unrefined
