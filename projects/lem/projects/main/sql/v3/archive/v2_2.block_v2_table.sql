CREATE TABLE v2_2.block_v2_table AS 
 SELECT main.geoid,
   ...
   --------------------------------------------------------------------------------
    ...
    ---join biomes dataset
    LEFT JOIN v2_2.block_zonal_maj_biomes as biomes ON main.geoid::text = biomes.geoid;
