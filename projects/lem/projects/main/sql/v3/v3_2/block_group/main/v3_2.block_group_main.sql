...
CREATE TABLE v3_2.block_group_main AS
SELECT
    main.objectid, 
    main.geoid,
...
FROM v3_2.block_group AS main

-----join nbrlist table
LEFT JOIN v3_2.block_group_nbrlist as neighbors ON main.geoid = neighbors.geoid
...
CREATE INDEX v3_2_block_group_main_geoid_idx ON v3_2.block_group_main (geoid);

---create index using geom column
CREATE INDEX v3_2_block_group_main_geom_idx ON v3_2.block_group_main USING gist (geom);