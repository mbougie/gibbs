...
# conn_string = "host='34.70.52.24' dbname='yo' user='postgres' password='Ecology76'"
...
# engine = create_engine('postgresql://postgres:Ecology76@34.70.52.24:5432/yo')

def importCSV(csv, pgdb, schema, table):
	# engine = create_engine('postgresql://mbougie:Mend0ta!@144.92.235.105:5432/{0}'.format(pgdb))
	# engine = create_engine('postgresql://postgres:Ecology76@34.70.52.24:5432/yo')
	engine = create_engine('postgresql://postgres:postgres@localhost/synthesis/{0}'.format(pgdb))
