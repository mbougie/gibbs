...
#             
#             ----Note: the unit for this column is Gg-----------------------
#             ((n2o.mean * factor_n2o.conv_factor)/1000) + ((carbon.mean * factor_carbon.conv_factor)) as current_field,
#             
#             geom
#             
#             FROM 
...
# obj = jsondata$n2o$n2o_ext
# obj = jsondata$agroibis$SEDrunoff_net
# obj = jsondata$area_county$area_net


## ext and net #####
query_specific <- gsub("dataset",obj$dataset,query_ext)
