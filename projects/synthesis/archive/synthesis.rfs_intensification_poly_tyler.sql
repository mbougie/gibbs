...
SELECT 
  ...
  ((sum(a.acres * (a.rot_prob_cc_rfs - A.NOT_RFS)))/ SUM(A.ACRES)*100 , 


  --Sum of the change in acres of continuous corn in each county.
  ((sum(a.acres * (a.rot_prob_cc_rfs - A.NOT_RFS))), 
