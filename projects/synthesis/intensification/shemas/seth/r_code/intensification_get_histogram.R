...
### ext #####
query_specific <- gsub("dataset",jsondata$intensification$net$napp$dataset,query_ext)
query_specific <- gsub("lookup",jsondata$intensification$net$napp$lookup,query_specific)

print(query_specific)

jsondata$intensification$net$napp$df <- get_postgis_query(con_synthesis,
                                                  query_specific,
                                                  geom_name = "geom")################################################################
...
rm(obj)
obj = jsondata$intensification$net$napp
print(obj$dataset)
