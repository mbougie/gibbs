...
createObject <- function(figure_params, parent, child, grandchild){
  ...
  ggplot_obj = createMap(df, obj, figure_params)
...
runMain <- function(parent, figure_params){
  ...
  for(i in figure_params$col1){
    ...
    ggplot_object <- createObject(figure_params, parent=parent, child=i$child, grandchild=i$grandchild)
...
figure_params = figure_obj$extensification$sup3
merge_ggplotlists <- runMain(parent = "extensification", figure_params)
