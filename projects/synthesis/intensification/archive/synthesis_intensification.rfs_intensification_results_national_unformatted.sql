create table synthesis_intensification.rfs_intensification_results_national_unformatted as 
...
--------- CC -----------------------------------------------------------------------------------------------
--------- RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_cc_rfs) as acres_rot_cc_rfs, 
--------- NON-RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_cc_non_rfs) as acres_rot_cc_nonrfs,


--------- SS -----------------------------------------------------------------------------------------------
--------- RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_ss_rfs) as acres_rot_ss_rfs, 
--------- NON-RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_ss_non_rfs) as acres_rot_ss_nonrfs,


--------- WW -----------------------------------------------------------------------------------------------
--------- RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_ww_rfs) as acres_rot_ww_rfs, 
--------- NON-RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_ww_non_rfs) as acres_rot_ww_nonrfs,


--------- CS -----------------------------------------------------------------------------------------------
--------- RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_cs_rfs) as acres_rot_cs_rfs, 
--------- NON-RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_cs_non_rfs) as acres_rot_cs_nonrfs,


--------- CW -----------------------------------------------------------------------------------------------
--------- RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_cw_rfs) as acres_rot_cw_rfs, 
--------- NON-RFS -----------------------------------------------------------------------------------------------
sum(a.acres * a.rot_prob_cw_non_rfs) as acres_rot_cw_nonrfs,


--------- OO -----------------------------------------------------------------------------------------------
--------- RFS -----------------------------------------------------------------------------------------------
sum(a.acres * (a.rot_prob_ss_rfs + a.rot_prob_ww_rfs)) as acres_rot_oo_rfs,
--------- NON-RFS -----------------------------------------------------------------------------------------------
sum(a.acres * (a.rot_prob_ss_non_rfs + a.rot_prob_ww_non_rfs)) as acres_rot_oo_nonrfs,


--------- CO -----------------------------------------------------------------------------------------------
--------- RFS -----------------------------------------------------------------------------------------------
sum(a.acres * (a.rot_prob_cs_rfs + a.rot_prob_cw_rfs)) as acres_rot_co_rfs, 
--------- NON-RFS -----------------------------------------------------------------------------------------------
sum(a.acres * (a.rot_prob_cs_non_rfs + a.rot_prob_cw_non_rfs)) as acres_rot_co_nonrfs, 
