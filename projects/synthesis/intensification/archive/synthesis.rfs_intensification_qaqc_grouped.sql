CREATE TABLE synthesis.rfs_intensification_qaqc_grouped_new_yo as
...
(sum(a.acres * (a.rot_prob_cc_rfs - a.rot_prob_cc_non_rfs)*d.leach_cc)) as acres_change_rot_cc_leach,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_cc_rfs - a.rot_prob_cc_non_rfs)*d.pyield_cc)) as acres_change_rot_cc_pyield,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_cc_rfs - a.rot_prob_cc_non_rfs)*d.sedyield_cc)) as acres_change_rot_cc_sedyield,


--Increased xxxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_ss_rfs - a.rot_prob_ss_non_rfs)*d.leach_ss)) as acres_change_rot_ss_leach,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_ss_rfs - a.rot_prob_ss_non_rfs)*d.pyield_ss)) as acres_change_rot_ss_pyield,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_ss_rfs - a.rot_prob_ss_non_rfs)*d.sedyield_ss)) as acres_change_rot_ss_sedyield,


--Increased xxxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_ww_rfs - a.rot_prob_ww_non_rfs)*d.leach_ww)) as acres_change_rot_ww_leach,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_ww_rfs - a.rot_prob_ww_non_rfs)*d.pyield_ww)) as acres_change_rot_ww_pyield,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_ww_rfs - a.rot_prob_ww_non_rfs)*d.sedyield_ww)) as acres_change_rot_ww_sedyield,


--Increased xxxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_sc_rfs - a.rot_prob_sc_non_rfs)*d.leach_sc)) as acres_change_rot_sc_leach,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_sc_rfs - a.rot_prob_sc_non_rfs)*d.pyield_sc)) as acres_change_rot_sc_pyield,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_sc_rfs - a.rot_prob_sc_non_rfs)*d.sedyield_sc)) as acres_change_rot_sc_sedyield,


--Increased xxxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_wc_rfs - a.rot_prob_wc_non_rfs)*d.leach_wc)) as acres_change_rot_wc_leach,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_wc_rfs - a.rot_prob_wc_non_rfs)*d.pyield_wc)) as acres_change_rot_wc_pyield,
--Increased xxxxxxx from increased continuous corn in a county.
(sum(a.acres * (a.rot_prob_wc_rfs - a.rot_prob_wc_non_rfs)*d.sedyield_wc)) as acres_change_rot_wc_sedyield,
